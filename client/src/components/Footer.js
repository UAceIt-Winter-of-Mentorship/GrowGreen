    ...
    render() {
     ...
     <div className="row py-5">
         <div className="col-lg-12 text-white text-center">
             <h1 className="display-3 ">GrowGreen</h1>
             <p className="lead mb-0">Grow Green allows contributors worldwide to create awareness about environment and do their bit by contributing.</p>
             <p className="lead py-3">An Eco Web App</p>
         </div>
     </div>
 </div>
 <footer className="bg-white">
     ...
     <div className="bg-light py-2">
         <div className="container text-center">
             <p className="text-muted mb-0 py-2">© 2019 GrowGreen All rights reserved.</p>
         </div>
     </div>
 </footer>
 </div>
